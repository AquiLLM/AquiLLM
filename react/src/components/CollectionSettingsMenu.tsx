    ...
    <div ref={menuRef} style={{ position: 'relative' }}>
      <button
        className={triggerLabel
          ? 'h-[36px] px-3 border border-border-mid_contrast rounded-[18px] bg-scheme-shade_4 hover:bg-scheme-shade_5 text-sm text-text-normal'
          : 'hover:bg-scheme-shade_5 rounded-md p-2'}
