...
_BASELINE_MAX_LINES: dict[str, int] = {
    ...
    "aquillm/apps/knowledge_graph/resolution/collection.py": 4474,
    ...
    "aquillm/apps/knowledge_graph/retrieval/expansion.py": 4065,
    ...
    "aquillm/apps/knowledge_graph/tests/test_build_generation_uniqueness.py": 338,
    ...
    "aquillm/apps/knowledge_graph/tests/test_canonical_resolution.py": 1269,
    "aquillm/apps/knowledge_graph/tests/test_collection_resolution.py": 2115,
    "aquillm/apps/knowledge_graph/tests/test_coreference.py": 2464,
    "aquillm/apps/knowledge_graph/tests/test_document_lifecycle.py": 1150,
    "aquillm/apps/knowledge_graph/tests/test_eval_runner.py": 3134,
    "aquillm/apps/knowledge_graph/tests/test_filtering.py": 739,
    "aquillm/apps/knowledge_graph/tests/test_graph_activation_lifecycle.py": 493,
    ...
    "aquillm/apps/knowledge_graph/tests/test_retrieval_snapshot.py": 716,
    ...
    "aquillm/tests/integration/test_vllm_extra_args_parser.py": 628,
