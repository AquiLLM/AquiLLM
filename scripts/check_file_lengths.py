...
_BASELINE_MAX_LINES: dict[str, int] = {
    ...
    "aquillm/apps/chat/tests/test_direct_rag_pipeline.py": 642,
    "aquillm/apps/chat/tests/test_llm_complete_retry.py": 854,
    ...
    "aquillm/apps/documents/tests/test_chunk_search_graph_overlay.py": 1101,
    ...
    "aquillm/apps/knowledge_graph/tests/test_graph_assembly.py": 843,
    "aquillm/apps/knowledge_graph/tests/test_graph_assembly_limits.py": 365,
    ...
    "aquillm/apps/knowledge_graph/tests/test_mention_extraction.py": 1565,
    ...
    "aquillm/apps/knowledge_graph/tests/test_tasks.py": 1312,
    "aquillm/apps/memory/tests/test_profile_fact_bridge.py": 320,
    "aquillm/aquillm/crawler_tasks.py": 425,
    "aquillm/aquillm/memory.py": 436,
    "aquillm/aquillm/settings.py": 470,
    ...
    "aquillm/lib/llm/tests/test_rag_citations.py": 1410,
    "aquillm/lib/llm/tests/test_spin_tool_budget.py": 337,
    "aquillm/lib/tools/search/tests/test_vector_search_pack.py": 306,
    ...
    "aquillm/tests/integration/test_knowledge_graph_compose.py": 362,
    "aquillm/tests/integration/test_vllm_extra_args_parser.py": 680,
