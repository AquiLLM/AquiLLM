...
def activate_collection_graph(
    ...
    *,
    ...
    with transaction.atomic():
        ...
        artifact.evaluation_only or __import__("apps.knowledge_graph.projection.runtime", fromlist=["enqueue_activated_collection_projection"]).enqueue_activated_collection_projection(collection_id, artifact.pk)  # noqa: E501
        return result
