...
from .memory import search_past_chats_tool
...
def build_memory_tools(user: User, chat_ref: ChatRef) -> list[LLMTool]:
    return [
        search_past_chats_tool(user, chat_ref),
    ]
