...
class ZoteroOAuthClient:
    ...
    def get_authorization_url(self, callback_url: str, permissions: Dict[str, str] = None) -> Tuple[str, str, str]:
        ...
        try:
            ...
            logger.info("obs.zotero.oauth_url_generated", callback_url=callback_url)
            return auth_url, oauth_token, oauth_token_secret

        except Exception as e:
            logger.error("obs.zotero.oauth_url_error", error=str(e), error_type=type(e).__name__)
            raise
    ...
    def get_access_token(self, oauth_token: str, oauth_token_secret: str, oauth_verifier: str) -> Dict[str, str]:
        ...
        try:
            ...
            logger.info("obs.zotero.access_token_obtained", username=username, user_id=user_id)
            ...
            logger.error("obs.zotero.access_token_error", error=str(e), error_type=type(e).__name__)
            raise
