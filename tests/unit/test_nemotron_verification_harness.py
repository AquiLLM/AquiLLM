...
def test_profile_verifier_self_test_covers_failure_policy_and_image_provenance() -> None:
...
def test_profile_verifier_requires_full_profile_unless_measurement_is_opted_in() -> None:
